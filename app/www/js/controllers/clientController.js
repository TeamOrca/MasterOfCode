angular.module('supeer.controllers')
    .controller('ClientCtrl', function($scope, $ionicPopup,  $ionicListDelegate, $location) {
      $scope.listCanSwipe = true;
      $scope.shouldShowDelete = true;
      $scope.requests = [
        {name: 'Plumber inc.', phone: '444-444-4444', wantedDate: '2015-10-10 at 9:00', status: 'pending'},
        {name: 'Housekeeper inc.', phone: '123-123-1232', wantedDate: '2015-10-10 at 13:10', status: 'pending'},
      ];
